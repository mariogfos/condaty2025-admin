              ...
              <div className={styles.reservationBlock}>
                <div className={styles.requesterSection}>
                  <div className={styles.requesterInfoContainer}>
                    <Avatar
                      hasImage={reservationDetail.owner?.has_image}
                      src={getUrlImages(
                    ...
                    <div className={styles.requesterText}>
                      ...
                      {reservationDetail.dpto && (
                        <span className={styles.requesterApt}>
                          Dpto: {reservationDetail.dpto.nro || reservationDetail.dpto.description || "-"}
                        </span>
                      )}
                    </div>
                  </div>
                      ...
                      <div className={styles.detailsList}>
                        <div className={styles.detailItem}>
                          ...
                          <span className={styles.detailText}>
                            {reservationDetail.date_at
                              ? getFormattedReservationDate(reservationDetail.date_at)
                              : ""}
                          </span>
                        </div>
                        <div className={styles.detailItem}>
                          ...
                          <span className={styles.detailText}>
                            {getFormattedReservationTime(reservationDetail.periods)}
                          </span>
                        </div>
                        <div className={styles.detailItem}>
                        ...
                        <div className={styles.detailItem}>
                          ...
                          <span className={styles.priceDetailText}>
                            {getPriceDetails(reservationDetail.area, reservationDetail.amount)}
                          </span>
                        </div>
                      </div>
                    </div>
