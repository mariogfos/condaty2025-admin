...
import {
  IconParagraph,
  IconParkListCheckbox,
  IconSingleChoiceSurvey,
  IconTowtoneLinearScale,
  IconX,
      ...
      <div className={styles.surveyQuestionTypePanel}>
        ...
        <section>
          <div
            ...
            onClick={() => openSurveyType("S")}
          >
            <div className={styles.icon}>
              <IconSingleChoiceSurvey size={32} />
            </div>
            <div className={styles.textContainer}>
              <h3>Opción única</h3>
              <p>
                El usuario solo podrá elegir una opción de respuesta de una
                lista predefinida.
              </p>
            </div>
          </div>
          <div
            className={styles.questionTypeOption}
            onClick={() => openSurveyType("M")}
          >
            <div className={styles.icon}>
              <IconParkListCheckbox size={32} />
            </div>
            <div className={styles.textContainer}>
              <h3>Opción múltiple</h3>
              <p>
                El usuario podrá elegir una o más opciones de respuesta de una
                lista.
              </p>
            </div>
          </div>
          <div
            className={styles.questionTypeOption}
            onClick={() => openSurveyType("E")}
          >
            <div className={styles.icon}>
              <IconTowtoneLinearScale size={32} />
            </div>
            <div className={styles.textContainer}>
              <h3>Opción en escala</h3>
              <p>
                El usuario asigna una puntuación entre 1 y 10, o una escala
                personalizada.
              </p>
            </div>
          </div>
          <div
            className={styles.questionTypeOption}
            onClick={() => openSurveyType("T")}
          >
            <div className={styles.icon}>
              <IconParagraph size={32} />
            </div>
            <div className={styles.textContainer}>
