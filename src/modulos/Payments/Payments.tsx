...
const Payments = () => {
  ...
  const fields = useMemo(
    () => ({
      ...
      // Campos ocultos necesarios para el payload y manejo de archivos
      file: {
        api: 'ae',
        form: {
          type: 'fileUpload',
          ext: ['jpg', 'pdf', 'png', 'jpeg', 'doc', 'docx'],
        },
        prefix: 'PAY',
      },
      voucher: { api: 'ae' },
        ...
        >
          <>
            <WidgetGrafIngresos
              ...
              subtitle={'Ingresos perteneciente en fecha ' + getDateDesdeHasta(convertFilterDate())}
            />
          </>
        </DataModal>
      )}
        ...
        <Input
          ...
          onChange={e => {
            ...
            if (customDateErrors.startDate)
              setCustomDateErrors(prev => ({ ...prev, startDate: undefined }));
          }}
          required
        />
        <Input
