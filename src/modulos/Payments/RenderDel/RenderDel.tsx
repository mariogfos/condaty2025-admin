      ...
      >
        <div className={styles.delContainer}>
          <p className={styles.warningText}>
            ¿Seguro que quieres anular este ingreso? Recuerda que si realizas
            esta acción perderás los cambios y no se reflejará en tu flujo de
            efectivo.
          </p>
          ...
          {canceledObs && canceledObs.length > 0 && (
            <p className={styles.charCount}>
              {canceledObs.length}/500 caracteres
            </p>
          )}
        </div>
      </DataModal>
