...
const _schema = i.schema({
  ...
  entities: {
    ...
    chatbot: i.entity({
      asignatedAt: i.number().optional(),
      chatbot: i.string().optional(),
      client_id: i.string().indexed().optional(),
