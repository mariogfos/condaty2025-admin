...
export default defineConfig({
  ...
  test: {
    ...
    include: ['src/modulos/**/__tests__/**/*.{test,spec}.{ts,tsx}', 'src/mk/**/__tests__/**/*.{test,spec}.{ts,tsx}', 'src/components/**/__tests__/**/*.{test,spec}.{ts,tsx}', 'src/types/__tests__/**/*.{test,spec}.{ts,tsx}', 'src/styles/__tests__/**/*.{test,spec}.{ts,tsx}', 'src/test/__tests__/**/*.{test,spec}.{ts,tsx}'],
